...
export default function MainHeader() {
	return (
		<header className='bg-white dark:bg-darkblue sticky z-30 top-0 flex items-center justify-between py-6 px-7 sm:px-16 quadHD:px-20 transition-all shadow-md' id="mainHeader">
