export default function BackToTopBtn() {
	...
	return (
		<button onClick={() => scroll(0, 0)} id="topArrow" className='bg-verylightgray dark:bg-darkblue p-2 rounded-full fixed bottom-5 left-5 transition-all opacity-0 translate-y-12 hover:opacity-80 hover:scale-105 active:scale-95 shadow-sm' title='Back to top'>
