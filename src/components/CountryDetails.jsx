		...
		<>
			{true
				? <div className="fixed overflow-hidden w-full h-screen pointer-events-none z-20" >
					< section className={`absolute top-0 ${show ? "right-0" : "-right-full"} transition-all w-full bg-white dark:bg-verydarkblue pointer-events-auto h-full py-14 px-8 md:px-20 mt-16 overflow-auto`}>
						...
						<article className="flex justify-between gap-6 items-center flex-col sm:flex-row w-full max-h-[22rem]">
